...
<head>
    ...
    <title>Society Manager Pro - Dashboard</title>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">₹1,432,145.69</div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">₹88,000</div>
                                        </div>
                                        <div class="col-auto">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mt-4 text-center small">
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-primary"></i> Maintainance
                                        </span>
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-success"></i> Bank Interest
                                        </span>
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-info"></i> Donation
                                        </span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-lg-5">
                            <div class="card shadow mb-4">
                                <!-- Card Header - Dropdown -->
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Monthly Expense Tracker</h6>
                                    <div class="dropdown no-arrow">
                                        <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink"
                                           data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <i class="fas fa-ellipsis-v fa-sm fa-fw text-gray-400"></i>
                        ...
                        <div class="col-xl-4 col-lg-5">
                            <div class="card shadow mb-4">
                                <!-- Card Header - Dropdown -->
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Members Summary</h6>
                                    <div class="dropdown no-arrow">
                                        <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink"
                                           data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <i class="fas fa-ellipsis-v fa-sm fa-fw text-gray-400"></i>
                                ...
                                <div class="card-body">
                                    <div class="members">
                                        ...
                                        <div class="total-pie-info">
                                            <p>Total Blocks</p>
                                        </div>
                                        <div class="member-pie">
                                            <div class="c100 p96 small green">
                                                <span>335</span>
                                                <div class="slice">
                                                    <div class="bar"></div>
                                                    <div class="fill"></div>
                                        ...
                                        <div class="member-pie-info">
                                            <p>Members</p>
                                        </div>
                                        <div class="tenent-pie">
                                            <div class="c100 p7 small green">
                                                <span>25</span>
                                                <div class="slice">
                                                    <div class="bar"></div>
                                                    <div class="fill"></div>
                                        ...
                                        <div class="tenent-pie-info">
                                            <p>Tenents</p>
                                        </div>
                                        <div class="vacant-pie">
                                            <div class="c100 p4 small green">
                                                <span>15</span>
                                                <div class="slice">
                                                    <div class="bar"></div>
                                                    <div class="fill"></div>
                        ...
                        <div class="col-xl-4 col-lg-5">
                            <div class="card shadow mb-4">
                                <!-- Card Header - Dropdown -->
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Parking Allotment</h6>
                                    <div class="dropdown no-arrow">
                                        <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink"
                                           data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <i class="fas fa-ellipsis-v fa-sm fa-fw text-gray-400"></i>
                                ...
                                <div class="card-body">
                                    <div class="parking">
                                        <div class="parking-alloted">
                                            <img src="img/Parking.svg" style="width: 40px;" class="image" alt="" />
                                        </div>
                                        <div class="parking-alloted-info">
                                            <p>Parking Alloted<br />(182)</p>
                                        </div>
                                        <div class="pending-requests">
                                            <img src="img/Wall-clock.svg" style="width: 40px;" class="image" alt="" />
                                        </div>
                                        <div class="pending-requests-info">
                                            <p>Pending Requests<br />(2)</p>
                                        </div>
                                        <div class="four-wheeler">
                                            <img src="img/Sedan-car-front.svg" style="width: 40px;" class="image" alt="" />
                                        </div>
                                        <div class="four-wheeler-info">
                                            <p>4 Wheelers<br />(104)</p>
                                        </div>
                                        <div class="two-wheeler">
                                            <img src="img/Motorbike.svg" style="width: 40px;" class="image" alt="" />
                                        </div>
                                        <div class="two-wheeler-info">
                                            <p>2 Wheelers<br />(82)</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <h4 class="small font-weight-bold">
                                        Overdue <span class="float-right">10%</span>
                                    </h4>
                                    ...
                                    <h4 class="small font-weight-bold">
                                        In Progess <span class="float-right">20%</span>
                                    </h4>
                                    <div class="progress mb-4">
                                    ...
                                    <h4 class="small font-weight-bold">
                                        Solved <span class="float-right">70%</span>
                                    </h4>
                                    <div class="progress">
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <h4 class="small font-weight-bold">
                                        Pending <span class="float-right">20%</span>
                                    </h4>
                                    <div class="progress mb-4">
                                        <div class="progress-bar bg-warning" role="progressbar" style="width: 20%"
                                             aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"></div>
                                    ...
                                    <h4 class="small font-weight-bold">
                                        Completed <span class="float-right">80%</span>
                                    </h4>
                                    <div class="progress">
