<main>
                    ...
                    <div class="container-xl px-4 mt-4">
                            ...
                            <div class="col-lg-4 mb-4">
                                ...
                                <div class="card h-100 border-start-lg border-start-primary">
                                    <div class="card-body">
                                        ...
                                        <div class="h3"><i class="fas fa-rupee-sign" style="font-size:large"></i> 2000.00</div>
                            ...
                            <div class="col-lg-4 mb-4">
                                ...
                                <div class="card h-100 border-start-lg border-start-success">
                                    <div class="card-body">
                                        ...
                                        <div class="h3 d-flex align-items-center">Standard</div>
                        ...
                        <div class="card card-header-actions mb-4">
                            <div class="card-header ms-0 font-weight-bold">
                                Payment Methods
                        ...
                        <div class="card mb-4">
                            <div class="card-header ms-0 font-weight-bold">Billing History</div>
                                    ...
                                    <table class="table mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>#39201</td>
                                                <td>06/15/2021</td>
                                                <td><i class="fas fa-rupee-sign" style="font-size:small"></i>29.99</td>
